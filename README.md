...
**Frontend Development:** HTML5, CSS3, JavaScript (ES6+), TypeScript, Asynchronous Data (AJAX, JSON)<br />
**Frameworks & Libraries:** React, jQuery<br />
**Styling & UI Frameworks:** Tailwind CSS, Bootstrap, Foundation<br />
**Architecture & UI Practices:** Component-Based Architecture, Responsive Design, Analytics Implementation (GTM/GA4), and OneTrust Compliance<br />
**Backend, CMS & Platforms:** PHP, MySQL, WordPress (Custom), Liquid, TinaCMS (Headless CMS)<br />
**Accessibility & Standards:** WCAG 2.1 Compliance, Accessible UI Implementation<br />
