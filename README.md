...
**Frontend Development:** HTML5, CSS3, JavaScript (ES6+), TypeScript, Asynchronous Data (AJAX, JSON)

**Frameworks & Libraries:** React, jQuery

**Styling & UI Frameworks:** Tailwind CSS, Bootstrap, Foundation

**Architecture & UI Practices:** Component-Based Architecture, Responsive Design, Analytics Implementation (GTM/GA4), and OneTrust Compliance

**Backend, CMS & Platforms:** PHP, MySQL, WordPress (Custom), Liquid, TinaCMS (Headless CMS)

**Accessibility & Standards:** WCAG 2.1 Compliance, Accessible UI Implementation

**Tools & Design:** Git, Pantheon, Figma, Adobe Photoshop
